...
- breakdown line: 55%
- unit: 56%
- either (coverage line renders): 81%
...
- `(A) Equipamentos culturais (B) Indivíduo` (2 rows)
- `Assinatura/ Subscrição (até 2009); Equipamento (a partir de 2010)` (1 rows)
- `Decimal` (1 rows)
- `Equivalente a tempo completo (ETC)` (1 rows)
...
- first load: **272.7 KB** (ceiling 400)
- of which catalogue.json: **158.6 KB** (ceiling 250)
...
- question_ratio: 0.07444
- period_ratio: 0.07444
- breakdown_ratio_by_area: europa 49%, municipios 61%, portugal 55%
- unit_ratio_by_area: europa 100%, municipios 100%, portugal 9%
- question_ratio_by_area: europa 7%, municipios 5%, portugal 9%
- period_ratio_by_area: europa 7%, municipios 5%, portugal 9%
- separator_repairs: 37
- unit_contamination: 0
- unit_translated_ratio: 0.9887
...
- first_load_gzip_kb: 272.7
- catalogue_gzip_kb: 158.6

- **BREACH** detail_pages_missing: 7 > allowed 0
- **BREACH** unit_translated_ratio: 0.9887 < required 0.99
