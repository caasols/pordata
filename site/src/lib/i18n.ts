...
export const STRINGS: Record<string, Strings> = {
  pt: {
    ...
    summaryFilter: 'Resumo', summaryBadge: 'Resumo PORDATA',
    summaryTip: "Um dos indicadores que a PORDATA mostra no quadro-resumo de cada município ou país.",
    unit: 'unidade', chartSoon: 'gráfico em breve', openAt: 'Abrir na PORDATA',
  ...
  en: {
    ...
    summaryFilter: 'Summary', summaryBadge: 'PORDATA summary',
    summaryTip: "One of the indicators PORDATA shows in the summary table for each municipality or country.",
    unit: 'unit', chartSoon: 'chart coming', openAt: 'Open on PORDATA',
  ...
  es: {
    ...
    summaryFilter: 'Resumen', summaryBadge: 'Resumen PORDATA',
    summaryTip: "Uno de los indicadores que PORDATA muestra en el cuadro resumen de cada municipio o país.",
    unit: 'unidad', chartSoon: 'gráfico próximamente', openAt: 'Abrir en PORDATA',
  ...
  fr: {
    ...
    summaryFilter: 'Résumé', summaryBadge: 'Résumé PORDATA',
    summaryTip: "L'un des indicateurs que PORDATA affiche dans le tableau de synthèse de chaque municipalité ou pays.",
    unit: 'unité', chartSoon: 'graphique à venir', openAt: 'Ouvrir sur PORDATA',
  ...
  de: {
    ...
    summaryFilter: 'Übersicht', summaryBadge: 'PORDATA-Übersicht',
    summaryTip: "Einer der Indikatoren, die PORDATA in der Übersichtstabelle jeder Gemeinde oder jedes Landes zeigt.",
    unit: 'Einheit', chartSoon: 'Diagramm folgt', openAt: 'Auf PORDATA öffnen',
  ...
  it: {
    ...
    summaryFilter: 'Sintesi', summaryBadge: 'Sintesi PORDATA',
    summaryTip: "Uno degli indicatori che PORDATA mostra nel quadro di sintesi di ogni comune o paese.",
    unit: 'unità', chartSoon: 'grafico in arrivo', openAt: 'Apri su PORDATA',
