...
export const STRINGS: Record<string, Strings> = {
  pt: {
    ...
    unit: 'unidade', chartSoon: 'gráfico em breve', openAt: 'Abrir na PORDATA', notAvailable: 'n/d',
  ...
  en: {
    ...
    unit: 'unit', chartSoon: 'chart coming', openAt: 'Open on PORDATA', notAvailable: 'n/a',
  ...
  es: {
    ...
    unit: 'unidad', chartSoon: 'gráfico próximamente', openAt: 'Abrir en PORDATA', notAvailable: 'n/d',
  ...
  fr: {
    ...
    unit: 'unité', chartSoon: 'graphique à venir', openAt: 'Ouvrir sur PORDATA', notAvailable: 'n/d',
  ...
  de: {
    ...
    unit: 'Einheit', chartSoon: 'Diagramm folgt', openAt: 'Auf PORDATA öffnen', notAvailable: 'k. A.',
  ...
  it: {
    ...
    unit: 'unità', chartSoon: 'grafico in arrivo', openAt: 'Apri su PORDATA', notAvailable: 'n/d',
