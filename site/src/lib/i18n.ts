...
export const STRINGS: Record<string, Strings> = {
  pt: {
    ...
    sortSrcMany: 'Mais fontes', sortSrcFew: 'Menos fontes', sortRandom: 'Aleatório',
  ...
  en: {
    ...
    sortSrcMany: 'Most sources', sortSrcFew: 'Fewest sources', sortRandom: 'Random',
  ...
  es: {
    ...
    sortSrcMany: 'Más fuentes', sortSrcFew: 'Menos fuentes', sortRandom: 'Aleatorio',
  ...
  fr: {
    ...
    sortSrcMany: 'Plus de sources', sortSrcFew: 'Moins de sources', sortRandom: 'Aléatoire',
  ...
  de: {
    ...
    sortSrcMany: 'Meiste Quellen', sortSrcFew: 'Wenigste Quellen', sortRandom: 'Zufällig',
  ...
  it: {
    ...
    sortSrcMany: 'Più fonti', sortSrcFew: 'Meno fonti', sortRandom: 'Casuale',
